...
public class GameForumGetViewVO {
	int content_idx;
	int board_code;
	String title;
	int appids;
	 ...
	 * @param likes       게시글이 좋아요를 받은 수
	 * @param regdate     게시글 등록일자
	 */
	public GameForumGetViewVO(int content_idx, int board_code, String title, int appids, String nickname,
